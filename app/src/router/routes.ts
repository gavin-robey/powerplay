...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'chat', name: 'ChatPage', component: () => import('src/pages/chat/ChatPage.vue'), meta: { title: 'Chat' } },
      { path: 'chat/:id', name: 'Chat', component: () => import('pages/chat/ChatUi.vue'), meta: { title: 'Chat' },},
